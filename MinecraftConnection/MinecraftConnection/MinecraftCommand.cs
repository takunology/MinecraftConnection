...
namespace MinecraftConnection
{
    public class MinecraftCommand : IDisposable
    {
        ...
        public string Summon(IEntity entity, double x, double y, double z) => SendCommand($"summon {entity.EntityName} {x} {y} {z} {entity.GetNBT()}");
        ...
        private static readonly HashSet<string> ForbiddenCommands = new()
        {
            "stop"
        };
